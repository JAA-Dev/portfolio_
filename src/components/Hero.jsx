  ...
  return (
    <section className="relative h-screen flex items-center justify-center overflow-hidden bg-linear-to-br from-white via-gray-50 to-gray-100 pt-20">
      ...
      <div className="absolute inset-0 overflow-hidden" id="home">
        ...
        <div className="relative mt-9 z-10 max-w-6xl mx-auto px-6 text-center h-full flex flex-col justify-center">
          <div
            ...
            <div className="flex flex-col sm:flex-row gap-3 justify-center mb-8 animate-fade-in-up delay-300">
              {heroData.ctaButtons.map((button, index) => (
                <a
                  ...
                  download={
                    button.variant === "primary" ? "Augustine Angeles - CV.pdf" : undefined
                  }
      ...
      {/* Floading Element */}
      <div className="absolute top-25 left-10 w-4 h-4 bg-blue-400 rounded-full opacity-60 animate-bounce blur">
      </div>
      <div className="absolute top-30 right-20 w-6 h-6 bg-purple-600 rounded-full opacity-60 animate-bounce blur delay-1000">
      </div>
      <div className="absolute bottom-30 left-15 w-3 h-3 bg-green-400 rounded-full opacity-60 animate-bounce blur delay-2000">
      </div>
      <div className="absolute bottom-20 right-10 w-5 h-5 bg-orange-400 rounded-full opacity-60 animate-bounce blur delay-3000">
      </div>
    </section>
  );
};
