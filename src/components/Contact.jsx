...
//   const SERVICE_ID = "service_n93pzfc";
//   const TEMPLATE_ID = "template_kk9hola";
//   const PUBLIC_KEY = "vjFc4oYqJlhzQmXLg";
...
//       })
//       .then(() => alert("Opps! Something went wrong. please try again."));
//   }
...
import { userIntersectionObserver } from "../hooks/userIntersectionObserver";
import { useScrollToTop } from "../hooks/useScrollToTop";
import { Github, Phone, Mail, SendHorizontal, Instagram } from "lucide-react";
import emailjs from "emailjs-com";
import { useState } from "react";
              ...
              <form className="space-y-6" onSubmit={handleSubmit}>
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full p-2 rounded-lg bg-white dark:bg-white/10 border border-gray-300 dark:border-white/20"
                  />
                </div>
                ...
                <button
                  type="submit"
                  className="w-full flex items-center justify-center gap-2 bg-black text-white p-2 rounded-lg font-semibold hover:bg-black/70 transition"
                >
